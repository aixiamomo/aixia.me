...
function loadJS(A, e, t) {
    var o = !!window.ActiveXObject, a = o && !window.XMLHttpRequest, i = document.createElement("script"), r = a ? document.documentElement : document.getElementsByTagName("head")[0];
    i.type = "text/javascript", i.async = !0, i.readyState ? i.onreadystatechange = function () {
        ...
        e && e()
    }, i.src = A, t ? document.getElementById(t).appendChild(i) : r.insertBefore(i, r.firstChild)
}

$.fn.extend({
    isOnScreenVisible: function () {
        if (!$("body").hasClass("post-template"))return !1;
        var A = $(window), e = {top: A.scrollTop(), left: A.scrollLeft()};
...
var duoshuoQuery = {short_name: "luolei"}, GlobalConfigue = {duoshuoDomain: "https://luolei.org"}, General = {
    isMobile: !1,
    isWechat: !1,
    viewWidth: $(window).width(),
    absUrl: location.protocol + "//" + location.host,
    init: function () {
        var A = window, e = (A.document, navigator.userAgent.toLowerCase()), t = A.navigator.appVersion.match(/android/gi);
    ...
    updateImageWidth: function () {
        function A() {
            var A = $(this), e = t.outerWidth(), o = this.naturalWidth;
        ...
        var t = $(".post-content"), o = $(".single-post-inner img").on("load", A);
        e()
    },
    webFontLoader: function () {
        WebFontConfig = {
            loading: function () {
            }, custom: {families: ["Exo", "iconfont"], urls: [General.absUrl + "/static/css/font.min.css"]}
        }, loadJS(General.absUrl + "/static/js/webfont.js", function () {
            WebFont.load({custom: {families: ["Exo", "iconfont"]}})
        })
    },
    arrowEvent: function () {
        $(".arrow_down").click(function () {
            return $("html,body").animate({scrollTop: $(window).height() - 20}, 600, function () {
                window.location.hash = "#"
            }), !1
        })
    },
    scrollToPos: function (A) {
        var e = "我要飞到最高", t = (A || $(window).height(), $('<a href="#" id="to-top" title="' + e + '"> <div class="to-top-wrap"></div></a>').appendTo("body"));
        $(window).scroll(function () {
            $(window).scrollTop() > $(window).height() ? t.fadeIn(500) : t.fadeOut(500)
        }), t.click(function (A) {
            A.preventDefault(), $("html,body").animate({scrollTop: 0}, 666, function () {
                window.location.hash = "#"
            })
        })
    },
    ...
    addIcons: function () {
        $(".single-post-inner  a:not(:has(img))").each(function (A) {
            var e = $(this).attr("href"), t = document.createElement("a");
            ...
            var o = $(this).find("i").css("color"), a = $(this).css("color");
            $(this).hover(function () {
                $(this).css("color", o), $(this).addClass("animated pulse")
            }, function () {
                $(this).css("color", a), $(this).removeClass("animated pulse")
            })
        })
    },
    // rewardLoader: function () {
    //     var A = {alipay: "/static/images/qr-alipay-256.png", wechat: "/static/images/qr-wechat-256.png"};
    ...
    commentLoader: function () {
        ...
        $(window).scroll(function () {
            return $(".comment-area").has("div").length > 0 ? !1 : void(($(".author-image").isOnScreenVisible() || $(".read-next").isOnScreenVisible()) && 0 == $(".author-image").hasClass("duoshuo-loaded") && ($(".author-image").addClass("duoshuo-loaded"), loadJS(General.absUrl + "/static/js/duoshuo.modify.js", function () {
    ...
    isWebPSupported: !1, isImageCompressed: !1, init: function () {
        ImageSmartLoader.webPCheck()
    }, isCompressedCheck: function () {
    }, webPCheck: function (A, e) {
        var t = {demo: "UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAsAAAABBxAREYiI/gcAAABWUDggGAAAADABAJ0BKgEAAQABABwlpAADcAD+/gbQAA=="}, o = new Image;
        o.onload = function () {
        ...
        if (1 == ImageSmartLoader.isWebPSupported) {
            ...
            General.viewWidth < 768 ? $(".lazy").lazyload({
                ...
                is_scale: !0,
                scale_width: 750
            }) : $(".lazy").lazyload({advanced_load: !0, data_attribute: "url", webP_load: !0, is_scale: !1})
        } else {
            if (768 == General.viewWidth)return $(".lazy").lazyload({
                advanced_load: !0,
                data_attribute: "url",
            ...
            General.viewWidth < 768 ? $(".lazy").lazyload({
                ...
                is_scale: !0,
                scale_width: 750
            }) : $(".lazy").lazyload({advanced_load: !0, data_attribute: "url", webP_load: !1, is_scale: !1})
        }
    }
};
$(document).ready(function () {
    ...
    $.fn.lazyload = function (e) {
        function t() {
            ...
            a.each(function () {
                var e = $(this);
                if (!i.skip_invisible || e.is(":visible"))if ($.abovethetop(this, i) || $.leftofbegin(this, i)); else if ($.belowthefold(this, i) || $.rightoffold(this, i)) {
        ...
        return e && (void 0 !== e.failurelimit && (e.failure_limit = e.failurelimit, delete e.failurelimit), void 0 !== e.effectspeed && (e.effect_speed = e.effectspeed, delete e.effectspeed), $.extend(i, e)), o = void 0 === i.container || i.container === window ? A : $(i.container), 0 === i.event.indexOf("scroll") && o.bind(i.event, function () {
            return t()
        }), this.each(function () {
            var A = this, e = $(A);
            A.loaded = !1, (void 0 === e.attr("src") || e.attr("src") === !1) && e.is("img") && (e.attr("src", i.placeholder), e.addClass("loading")), e.one("appear", function () {
                if (!this.loaded) {
                    if (i.appear) {
                        var t = a.length;
                        i.appear.call(A, t, i)
                    }
                    var o = e.attr("data-" + i.data_attribute);
                    (o.indexOf("upaiyun") > -1 || o.indexOf("file.is26.com") > -1) && (1 == i.advanced_load && (o += "!"), 1 == i.is_scale && (o += "/fw/" + i.scale_width), 1 == i.webP_load && (o += "/format/webp")), $("<img />").bind("load", function () {
                        e.hide(), e.is("img") ? e.attr("src", o) : e.css("background-image", "url('" + o + "')"), e[i.effect](i.effect_speed), A.loaded = !0;
                        var t = $.grep(a, function (A) {
                            return !A.loaded
                        });
                        if (a = $(t), i.load) {
                            var r = a.length;
            ...
            }), 0 !== i.event.indexOf("scroll") && e.bind(i.event, function () {
    ...
    }), General.init(), ImageSmartLoader.init(), $("body").hasClass("post-template") && (General.addIcons(), General.commentLoader())
});

// 悬停显示打赏
$(document).ready(function () {
    $("div .reward-button").hover(function () {
        var A = {alipay: "/static/images/qr-alipay-256.png", wechat: "/static/images/qr-wechat-256.png"};
        General.isWechat && $(".wechat-code b").html("长按上方二维码打赏作者"), $(".money-like .reward-button").hover(function () {
            $("img.wechat-img").attr("src", A.wechat), $("img.alipay-img").attr("src", A.alipay), $(".money-code").fadeIn(), $(this).addClass("active")
        }, function () {
